...
Copy the desired files into a dedicated directory where zsh can find it. Any directory in your path (fpath if you want the script available as a function) will be fine. Then (re)start zsh and the functions resp. scripts should be available on your system.
...
- [zsh_wifi_signal](helpers/scripts/misc/zsh_wifi_signal) - Check whether wlan0 is connected (this is no hacking tool)
